...
pub const ACCOUNTING_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "财务专员",
        include_str!(
            "../../../agency_experts/opc/capability_packs/accounting/accounting-financial-clerk.md"
        ),
    ),
    (
        ...
        "财务审批人",
        include_str!(
            "../../../agency_experts/opc/capability_packs/accounting/accounting-financial-approver.md"
        ),
    ),
    (
        ...
        "财务助理",
        include_str!(
            "../../../agency_experts/opc/capability_packs/accounting/accounting-financial-assistant.md"
        ),
    ),
    (
        ...
        "财务分析师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/accounting/accounting-financial-analyst.md"
        ),
    ),
];
...
pub const FINANCE_INVEST_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "市场分析师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/finance_invest/finance-market-analyst.md"
        ),
    ),
    (
        ...
        "行业研究员",
        include_str!(
            "../../../agency_experts/opc/capability_packs/finance_invest/finance-industry-researcher.md"
        ),
    ),
    (
        ...
        "资产配置专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/finance_invest/finance-asset-allocator.md"
        ),
    ),
    (
        ...
        "交易执行专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/finance_invest/finance-trade-executor.md"
        ),
    ),
    (
        ...
        "投资回顾专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/finance_invest/finance-portfolio-reviewer.md"
        ),
    ),
];
...
pub const GAME_DEV_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "游戏概念设计师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/game_dev/game-concept-designer.md"
        ),
    ),
    (
        ...
        "原型开发专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/game_dev/game-prototype-developer.md"
        ),
    ),
    (
        ...
        "内容设计师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/game_dev/game-content-designer.md"
        ),
    ),
    (
        "game-qa-expert",
        "游戏QA专家",
        include_str!("../../../agency_experts/opc/capability_packs/game_dev/game-qa-expert.md"),
    ),
    (
        "game-operations-expert",
        "游戏运营专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/game_dev/game-operations-expert.md"
        ),
    ),
];
...
pub const DESIGN_EXPERTS: &[(&str, &str, &str)] = &[
    (
        "design-ui-designer",
        "UI设计师",
        include_str!("../../../agency_experts/opc/capability_packs/design/design-ui-designer.md"),
    ),
    (
        "design-brand-strategist",
        "品牌设计师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/design/design-brand-strategist.md"
        ),
    ),
    (
        ...
        "设计系统专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/design/design-system-architect.md"
        ),
    ),
];
...
pub const ECOMMERCE_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "选品专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/ecommerce/ecommerce-product-scout.md"
        ),
    ),
    (
        ...
        "竞品分析师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/ecommerce/ecommerce-competitor-analyst.md"
        ),
    ),
    (
        ...
        "营销专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/ecommerce/ecommerce-marketing-planner.md"
        ),
    ),
];
...
pub const EDUCATION_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "课程设计师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/education/education-curriculum-designer.md"
        ),
    ),
    (
        ...
        "内容创作专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/education/education-content-creator.md"
        ),
    ),
    (
        ...
        "评估专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/education/education-assessment-expert.md"
        ),
    ),
];
...
pub const GEOSPATIAL_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "地理数据分析师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/geospatial/geospatial-data-analyst.md"
        ),
    ),
    (
        ...
        "可视化专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/geospatial/geospatial-visualization-expert.md"
        ),
    ),
    (
        ...
        "规划顾问",
        include_str!(
            "../../../agency_experts/opc/capability_packs/geospatial/geospatial-planning-advisor.md"
        ),
    ),
];
...
pub const CONSULTING_EXPERTS: &[(&str, &str, &str)] = &[
    (
        "consulting-research-analyst",
        "研究分析师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/consulting/consulting-research-analyst.md"
        ),
    ),
    (
        "consulting-strategy-advisor",
        "战略顾问",
        include_str!(
            "../../../agency_experts/opc/capability_packs/consulting/consulting-strategy-advisor.md"
        ),
    ),
    (
        "consulting-implementation-coach",
        "实施教练",
        include_str!(
            "../../../agency_experts/opc/capability_packs/consulting/consulting-implementation-coach.md"
        ),
    ),
];

pub const CONSULTING_PROFILE_TOOLS: &[(&str, &[&str])] = &[
    ("consulting-research-analyst", &["WebSearch", "OpcSearchWiki"]),
    ("consulting-strategy-advisor", &["OpcGetDashboard", "OpcSearchWiki"]),
    (
        "consulting-implementation-coach",
        &["OpcCreateProject", "OpcAddMilestone", "OpcListProjects"],
    ),
];
...
pub const PROJECT_MANAGEMENT_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "项目规划专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/project_management/project-planning-expert.md"
        ),
    ),
    (
        ...
        "项目监控分析师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/project_management/project-monitoring-analyst.md"
        ),
    ),
    (
        ...
        "交付管理专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/project_management/project-delivery-manager.md"
        ),
    ),
];
...
pub const SALES_GROWTH_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "线索生成专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/sales_growth/sales-lead-generator.md"
        ),
    ),
    (
        ...
        "谈判专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/sales_growth/sales-negotiation-expert.md"
        ),
    ),
    (
        ...
        "增长分析师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/sales_growth/sales-growth-analyst.md"
        ),
    ),
];
...
pub const SECURITY_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "合规审计师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/security/security-compliance-auditor.md"
        ),
    ),
    (
        ...
        "事件响应专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/security/security-incident-responder.md"
        ),
    ),
    (
        ...
        "风险评估专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/security/security-risk-assessor.md"
        ),
    ),
];
...
pub const SOFTWARE_DEV_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "软件架构师",
        include_str!(
            "../../../agency_experts/opc/capability_packs/software_dev/software-architect.md"
        ),
    ),
    (
        "software-developer",
        "开发专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/software_dev/software-developer.md"
        ),
    ),
    (
        ...
        "质量专家",
        include_str!(
            "../../../agency_experts/opc/capability_packs/software_dev/software-quality-expert.md"
        ),
    ),
];
