...
(l => {
  let m = (() => {
      ...
      return {
        ...
        getAndEncode: function(l) {
          ...
          e || (e = { url: l, promise: null }, d.impl.urlCache.push(e));
          null === e.promise
            && (d.impl.options.cacheBust && (l += (/\?/.test(l) ? "&" : "?") + (new Date()).getTime()),
              e.promise = new Promise(function(n) {
                ...
                if (
                  r.timeout = d.impl.options.httpTimeout,
                    r.onerror = t,
                    r.ontimeout = t,
                    r.onloadend = function() {
                      if (r.readyState === XMLHttpRequest.DONE) {
                        var e = r.status;
                        if (
                          0 === e && l.toLowerCase().startsWith("file://")
                          || 200 <= e && e <= 300 && null !== r.response
                        ) {
                          e = r.response;
                    ...
                    0 < d.impl.options.useCredentialsFilters.length
                    && (d.impl.options.useCredentials = 0 < d.impl.options.useCredentialsFilters.filter(e =>
                      0 <= l.search(e)
                    ).length),
                    d.impl.options.useCredentials && (r.withCredentials = !0),
                    d.impl.options.corsImg && 0 === l.indexOf("http") && -1 === l.indexOf(window.location.origin)
                ) {
        ...
        makeImage: function(r) {
          return "data:," !== r
            ? new Promise(function(e, t) {
              ...
              d.impl.options.useCredentials && (o.crossOrigin = "use-credentials"),
                o.onload = function() {
    ...
    r = (() => {
      ...
      return {
        ...
        shouldProcess: e,
        impl: { readUrls: n, inline: i, urlAsRegex: r },
      };
      function e(e) {
        return -1 !== e.search(o);
      }
  ...
  function t() {
    return Promise.resolve(m.asArray(document.styleSheets)).then(function(e) {
      ...
      return e.forEach(function(t) {
        ...
        if (Object.prototype.hasOwnProperty.call(e, "cssRules")) {
          try {
  ...
  let n = {
    inlineAll: function t(e) {
      ...
      return n(e).then(function() {
        return m.isHTMLImageElement(e) ? o(e).inline() : Promise.all(
          m.asArray(e.childNodes).map(function(e) {
            return t(e);
          }),
        );
      });
  ...
  let i = {
    ...
    d = {
      ...
      impl: {
        ...
        copyOptions: function(e) {
          void 0 === e.copyDefaultStyles
            ? d.impl.options.copyDefaultStyles = i.copyDefaultStyles
            : d.impl.options.copyDefaultStyles = e.copyDefaultStyles;
    ...
    f =
      ("object" == typeof exports && "object" == typeof module ? module.exports = d : l.domtoimage = d,
        (void 0 === Node ? void 0 : Node.ELEMENT_NODE) || 1),
    h = (void 0 === l ? void 0 : l.getComputedStyle) || (void 0 === window ? void 0 : window.getComputedStyle)
      || globalThis.getComputedStyle,
    s = (void 0 === l ? void 0 : l.atob) || (void 0 === window ? void 0 : window.atob) || globalThis.atob;
  function u(t, r) {
    ...
    return Promise.resolve(t).then(function(e) {
      ...
      return t.replaceWith(n), n.append(e), o.push({ child: t, wrapper: n }), n;
    }).then(function(e) {
      return function l(t, s, i, u) {
        let e = s.filter;
        if (
          t === p || m.isHTMLScriptElement(t) || m.isHTMLStyleElement(t) || m.isHTMLLinkElement(t)
          || null !== i && e && !e(t)
        ...
        function d(u, a) {
          return !m.isElement(u) || m.isShadowSlotElement(a)
            ? Promise.resolve(u)
            : Promise.resolve().then(t).then(n).then(o).then(r).then(e).then(function() {
              return u;
            });
          function e() {
            m.isHTMLImageElement(u) && (u.removeAttribute("loading"), a.srcset || a.sizes)
              && (u.removeAttribute("srcset"), u.removeAttribute("sizes"), u.src = a.currentSrc || a.src);
          }
          function t() {
            function o(e, t) {
              t.font = e.font,
            ...
            function e(e, t) {
              ...
              n.cssText
                ...
                : (y(s, e, n, i, t),
                  null === i
                  && (["inset-block", "inset-block-start", "inset-block-end"].forEach(e => t.style.removeProperty(e)),
          ...
          function o() {
            m.isHTMLTextAreaElement(a) && (u.innerHTML = a.value),
              m.isHTMLInputElement(a) && u.setAttribute("value", a.value);
          }
          function r() {
    ...
    }).then(r.disableEmbedFonts ? Promise.resolve(t) : c).then(r.disableInlineImages ? Promise.resolve(t) : g).then(
      function(t) {
      ...
      return Promise.resolve(e).then(function(e) {
        ...
        var t = (m.isDimensionMissing(n) ? ' width="100%"' : ` width="${n}"`)
          + (m.isDimensionMissing(o) ? ' height="100%"' : ` height="${o}"`);
        return `<svg xmlns="http://www.w3.org/2000/svg"${
          (m.isDimensionMissing(n) ? "" : ` width="${n}"`) + (m.isDimensionMissing(o) ? "" : ` height="${o}"`)
    ...
    return u(r, i = i || {}).then(m.makeImage).then(function(e) {
      var t = "number" != typeof i.scale ? 1 : i.scale,
        n = ((e, t) => {
          ...
          return m.isDimensionMissing(n) && (n = m.isDimensionMissing(o) ? 300 : 2 * o),
            m.isDimensionMissing(o) && (o = n / 2),
            (e = document.createElement("canvas")).width = n * t,
            e.height = o * t,
            i.bgcolor && ((t = e.getContext("2d")).fillStyle = i.bgcolor, t.fillRect(0, 0, e.width, e.height)),
            e;
        })(r, t),
        o = n.getContext("2d");
      return o.msImageSmoothingEnabled = !1,
  ...
  function c(n) {
    return e.resolveAll().then(function(e) {
      var t;
      return "" !== e
        && (t = document.createElement("style"), n.appendChild(t), t.appendChild(document.createTextNode(e))),
        n;
    });
  }
  function g(e) {
  ...
  function y(i, l, s, u, e) {
    let a = d.impl.options.copyDefaultStyles
        ? ((t, e) => {
          var n,
            o =
              (e =>
                ("relaxed" !== t.styleCaching ? e : e.filter((e, t, n) => 0 === t || t === n.length - 1)).join(">"))(
                  e = (e => {
                    var t = [];
                    do {
                      if (e.nodeType === f) {
              ...
              (n = (() => {
                ...
                t = document.characterSet || "UTF-8",
                  e = (e = document.doctype)
                    ...
                    : "",
                  (p = document.createElement("iframe")).id = "domtoimage-sandbox-" + m.uid(),
                  p.style.top = "-9999px",
                ...
                try {
                  return n.contentWindow.document.write(
                    e + `<html><head><meta charset='${t}'><title>${o}</title></head><body></body></html>`,
                  ),
                    n.contentWindow;
                } catch (e) {}
    ...
    m.asArray(s).forEach(function(e) {
      var t, n, o, r;
      i.filterStyles && !i.filterStyles(l, e)
        || (n = s.getPropertyValue(e), o = a[e], t = u ? u.getPropertyValue(e) : void 0, c.getPropertyValue(e))
        || (n !== o || u && n !== t)
          && (o = s.getPropertyPriority(e),
            t = c,
            n = n,
            o = o,
            r = 0 <= ["background-clip"].indexOf(e = e),
            o
              ? (t.setProperty(e, n, o), r && t.setProperty("-webkit-" + e, n, o))
              : (t.setProperty(e, n), r && t.setProperty("-webkit-" + e, n)));
    });
  }
  let v = null,
    w = {},
