...
pub(crate) fn strip_disabled_thinking_delta(delta: &str, state: &mut DisabledThinkingStripState) -> String {
...
pub(crate) fn format_conversation_for_title(messages: &[(MessageRole, String)], max_chars: usize) -> String {
