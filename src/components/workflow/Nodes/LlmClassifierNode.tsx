...
interface LlmClassifierNodeData extends Record<string, unknown> {
  id: string;
  type: string;
  title: string;
  color: string;
...
const LlmClassifierNodeComponent: React.FC<NodeProps> = ({ data, selected }) => {
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 12, color: NODE_COLOR, fontWeight: 600 }}>
            {t("workflow.nodeTypes.llmClassifier")}
          </span>
        </div>
