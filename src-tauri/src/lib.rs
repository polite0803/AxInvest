...
pub fn run() {
    ...
    let build_result = builder
        .invoke_handler(tauri::generate_handler![
            ...
            commands::reflection::get_reflection_config,
            commands::reflection::update_reflection_config,
            commands::reflection::delete_insight,
            commands::reflection::record_insight_feedback,
            commands::reflection::get_top_insights,
            commands::reflection::get_recent_insights,
            commands::reflection::get_high_confidence_insights,
            commands::reflection::prune_stale_insights,
            commands::reflection::decay_stale_insights,
            commands::reflection::get_insights_by_category,
            commands::reflection::export_insights,
            ...
            commands::stock_workflow::rerun_decision,
            commands::stock_workflow::record_decision_trust,
            commands::stock_workflow::query_decision_backtest,
            ...
            // Quant commands (M1)
            commands::quant::quant_strategies_list,
            commands::quant::quant_backtest_run,
            commands::quant::quant_metrics_compare,
            commands::quant::quant_strategy_register_rhai,
        ])
        .setup(|app| {
