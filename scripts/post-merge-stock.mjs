...
const zhCN = {
  ...
  watchlist: "自选股",
  "watchlist.all": "全部 ({{count}})",
  "watchlist.newGroup": "新分组名称...",
  "watchlist.move": "移动到分组",
  "watchlist.moveToAll": "移回全部",
  "watchlist.refreshQuotes": "刷新行情",
  "watchlist.sortByChange": "按涨跌幅",
  "watchlist.sortByCode": "按代码",
  "watchlist.sortByName": "按名称",
  "watchlist.analyzeAll": "分析全部",
  "watchlist.analysisStarted": "已启动 {{count}} 只股票分析",
  ...
  turnoverRate: "换手率",
  "valueAssessment.dataQuality": "dataQuality",
  "valueAssessment.empty": "empty",
  "valueAssessment.futureFields": "futureFields",
  "valueAssessment.rawData": "rawData",
  "valueAssessment.ruleCheck": "ruleCheck",
  "valueAssessment.title": "title",
  views: "浏览",
...
const enUS = {
  ...
  watchlist: "Watchlist",
  "watchlist.all": "All ({{count}})",
  "watchlist.newGroup": "New group name...",
  "watchlist.move": "Move to group",
  "watchlist.moveToAll": "Move to All",
  "watchlist.refreshQuotes": "Refresh Quotes",
  "watchlist.sortByChange": "Sort by Change",
  "watchlist.sortByCode": "Sort by Code",
  "watchlist.sortByName": "Sort by Name",
  "watchlist.analyzeAll": "Analyze All",
  "watchlist.analysisStarted": "Started analysis for {{count}} stocks",
