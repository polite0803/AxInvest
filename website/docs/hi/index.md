---
layout: home
title: AxAgent — ओपन-सोर्स AI डेस्कटॉप क्लाइंट & गेटवे
titleTemplate: false

head:
  - - meta
    - name: description
      content: AxAgent एक मुफ्त ओपन-सोर्स AI डेस्कटॉप क्लाइंट है जिसमें बिल्ट-इन AI गेटवे है। OpenAI, Claude, Gemini, DeepSeek और अधिक LLMs कनेक्ट करें। MCP सर्वर सपोर्ट, नॉलेज बेस, प्राइवेसी-फर्स्ट।
...
features:
  ...
  - icon: api
    ...
    details: Model Context Protocol का पूर्ण कार्यान्वयन। stdio, SSE, StreamableHTTP सपोर्ट। एक क्लिक में बाहरी टूल्स कनेक्ट करें। @axagent/fetch जैसे बिल्ट-इन MCP टूल्स।
  - icon: cloud-server
    title: बिल्ट-इन API गेटवे
    details: लोकल OpenAI-कम्पैटिबल API सर्वर। AxAgent को Claude Code, Codex, Gemini CLI आदि के बैकएंड के रूप में उपयोग करें। की मैनेजमेंट, रेट लिमिटिंग, SSL/TLS।
  - icon: book
    title: नॉलेज बेस & RAG
