...
import { Alert, App, Avatar, Popconfirm, Popover, Spin, Tag, theme, Typography } from "antd";
import { Bot, Check, Copy, MessageSquare, Pencil, RotateCcw, Save, Scissors, Trash2, User, X, Zap } from "lucide-react";
...
import { Actions, AssistantFooter, styleBtn } from "./AssistantFooter";
