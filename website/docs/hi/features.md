...
AxAgent एक पूर्ण-सुविधा वाला डेस्कटॉप AI असिस्टेंट है जो मल्टी-प्रोवाइडर चैट, शक्तिशाली कंटेंट रेंडरिंग, टूल इंटीग्रेशन और एक बिल्ट-इन API गेटवे को एक साथ लाता है — सब कुछ मजबूत डेटा सुरक्षा के साथ लोकल रूप से चलता है।
...
AxAgent में एक बिल्ट-इन Agent मोड शामिल है जो AI को सूक्ष्म अनुमति नियंत्रण के साथ स्वायत्त रूप से बहु-चरणीय कार्य निष्पादित करने में सक्षम बनाता है।
...
AxAgent एक समृद्ध, इंटरैक्टिव रेंडरिंग पाइपलाइन के साथ प्लेन टेक्स्ट चैट से बहुत आगे जाता है।
...
- **बिल्ट-इन टूल्स** — `@axagent/fetch` जैसे रेडी-टू-यूज़ बिल्ट-इन MCP टूल्स।
- **टूल एक्सीक्यूशन पैनल** — एक विज़ुअल पैनल हर टूल-कॉल रिक्वेस्ट और उसका रिटर्न रिजल्ट दिखाता है।

## API गेटवे

AxAgent में एक बिल्ट-इन लोकल API सर्वर शामिल है जो आपके डेस्कटॉप ऐप को एक शक्तिशाली AI गेटवे में बदल देता है।
...
- **आइसोलेटेड डेटा डायरेक्टरी** — ऐप्लिकेशन स्टेट `~/.axagent/` में। यूज़र-विज़िबल फ़ाइलें `~/Documents/axagent/` में।
...
फ़ाइल `~/.axagent/master.key` AxAgent में सभी एन्क्रिप्शन की जड़ है। इसे सुरक्षित रखें और अपने बैकअप में शामिल करें।
:::

## डेस्कटॉप अनुभव

AxAgent एक नेटिव डेस्कटॉप ऐप्लिकेशन के रूप में बनाया गया है।
...
- **ऑटो-स्टार्ट** — सिस्टम स्टार्टअप पर AxAgent को वैकल्पिक रूप से लॉन्च करें।
- **प्रॉक्सी सपोर्ट** — सीमित नेटवर्क एक्सेस वाले वातावरण के लिए HTTP और SOCKS5 प्रॉक्सी कॉन्फ़िगर करें।
- **ऑटो अपडेट** — AxAgent स्टार्टअप पर नए वर्जन की जांच करता है।
