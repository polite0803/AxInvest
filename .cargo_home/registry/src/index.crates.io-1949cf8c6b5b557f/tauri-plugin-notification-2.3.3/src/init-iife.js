      ...
      window.Notification = function(n, t) {
        ...
        !async function(n) {
          "object" == typeof n && Object.freeze(n),
            await i("plugin:notification|notify", { options: "string" == typeof n ? { title: n } : n });
        }(Object.assign(o, { title: n }));
      },
        window.Notification.requestPermission = async function() {
          return await i("plugin:notification|request_permission").then(
            i => (o("prompt" === i || "prompt-with-rationale" === i ? "default" : i), i),
          );
        },
        ...
        async function() {
          return "default" !== window.Notification.permission || __TEMPLATE_windows__
