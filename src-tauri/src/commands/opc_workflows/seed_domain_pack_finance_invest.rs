...
//! 金融投资流程域包工作流模板种子化（v4 丰富拓扑：LLM 条件门 + 修正分支 + 汇合）。
...
pub async fn seed_domain_pack_finance_invest_workflow_template(
    ...
    let template_data = WorkflowTemplateData {
        ...
        cluster_id: None,
        route_path: None,
        tags: vec!["opc".to_string(), "domain_pack".to_string(), "finance_invest".to_string()],
