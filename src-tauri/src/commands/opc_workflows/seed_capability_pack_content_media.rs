...
//! 内容媒体流程域包工作流模板种子化（v4 丰富拓扑：LLM 条件门 + 修正分支 + 汇合）。
...
pub async fn seed_capability_pack_content_media_workflow_template(
    ...
    let template_data = WorkflowTemplateData {
        ...
        cluster_id: None,
        route_path: None,
        tags: vec!["opc".to_string(), "capability_pack".to_string(), "content_media".to_string()],
