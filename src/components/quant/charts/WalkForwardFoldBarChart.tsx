        ...
        tooltip: {
          ...
          formatter: (params: unknown) => {
            ...
            return [
              ...
              `IS: ${f.trainStart} → ${f.trainEnd} (${t("quant.backtest.barsCount", { count: f.trainBarsCount })})`,
              `OOS: ${f.testStart} → ${f.testEnd} (${t("quant.backtest.barsCount", { count: f.testBarsCount })})`,
