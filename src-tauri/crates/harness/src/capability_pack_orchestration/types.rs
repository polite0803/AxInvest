...
pub struct CapabilityPackContext {
    /// 会话 ID
...
/// 域包学习配置
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CapabilityPackLearningConfig {
    /// 配置版本
...
impl Default for CapabilityPackLearningConfig {
    fn default() -> Self {
        Self {
            version: 1,
