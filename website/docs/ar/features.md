...
AxAgent مساعد AI لسطح المكتب متكامل يجمع بين الدردشة متعددة المزودين وعرض المحتوى القوي وتكامل الأدوات وبوابة API مدمجة — يعمل كل شيء محلياً مع حماية قوية للبيانات.
...
يتضمن AxAgent وضع Agent مدمج يمكّن الذكاء الاصطناعي من تنفيذ المهام متعددة الخطوات بشكل مستقل مع تحكم دقيق في الأذونات.
...
يتجاوز AxAgent الدردشة النصية البسيطة بكثير مع خط أنابيب عرض غني وتفاعلي.
...
- **أدوات مدمجة** — أدوات MCP مدمجة جاهزة للاستخدام مثل `@axagent/fetch`.
- **لوحة تنفيذ الأدوات** — تعرض لوحة مرئية كل طلب استدعاء أداة ونتيجة إرجاعه.

## بوابة API

يتضمن AxAgent خادم API محلي مدمجاً يحول تطبيق سطح المكتب إلى بوابة AI قوية.
...
تتيح لك البوابة استخدام AxAgent كخلفية AI موحدة لجميع أدواتك. وجّه عملاء CLI وامتدادات IDE أو البرامج النصية المخصصة نحو البوابة المحلية واستفد من تدوير المفاتيح وتتبع الاستخدام والتحكم في الوصول.
:::

## البيانات والأمان

بياناتك لا تغادر جهازك أبداً. AxAgent مُصمَّم مع الأمان المحلي أولاً في كل طبقة.

- **تشفير AES-256** — مفاتيح API والبيانات الحساسة الأخرى مشفرة محلياً بـ AES-256.
- **مجلدات بيانات معزولة** — حالة التطبيق في `~/.axagent/`. الملفات المرئية للمستخدم في `~/Documents/axagent/`.
...
الملف `~/.axagent/master.key` هو جذر كل التشفير في AxAgent. احتفظ به آمناً وأدرجه في نسخك الاحتياطية.
:::

## تجربة سطح المكتب

AxAgent مبني كتطبيق سطح مكتب أصلي مع الصقل والتكامل المتوقعَين من أداة الاستخدام اليومي.
...
- **بدء تلقائي** — تشغيل AxAgent اختيارياً عند بدء تشغيل النظام.
- **دعم الوكيل** — تكوين وكلاء HTTP وSOCKS5 للبيئات ذات الوصول المحدود للشبكة.
- **تحديثات تلقائية** — يتحقق AxAgent تلقائياً من الإصدارات الجديدة عند الإطلاق.
