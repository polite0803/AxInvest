...
pub struct AgentState {
    ...
    pub local_tool_registry:
        Arc<tokio::sync::Mutex<axagent_tools::registry::UnifiedToolRegistry>>,
...
impl AgentState {
    ...
    pub fn new(
        ...
        platform_manager: Arc<
            axagent_runtime::message_gateway::platform_manager::PlatformManager,
        >,
        platform_bridge: Arc<
            axagent_runtime::message_gateway::platform_bridge::PlatformBridge,
        >,
        local_tool_registry: Arc<
