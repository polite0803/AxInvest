...
interface DataTransformerNodeData extends Record<string, unknown> {
  id: string;
  type: string;
  title: string;
  color: string;
...
const DataTransformerNodeComponent: React.FC<NodeProps> = ({ data, selected }) => {
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 12, color: NODE_COLOR, fontWeight: 600 }}>
            {t("workflow.nodeTypes.dataTransformer")}
          </span>
        </div>
