    ...
    <div className="p-4">
      <Card title={t("devtools.tokenDistribution")}>
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <div className="text-zinc-500 text-sm mb-1">{t("devtools.inputTokens")}</div>
          ...
          <div>
            <div className="text-zinc-500 text-sm mb-1">{t("devtools.outputTokens")}</div>
          ...
          <div>
            <div className="text-zinc-500 text-sm mb-1">{t("devtools.cacheCreation")}</div>
          ...
          <div>
            <div className="text-zinc-500 text-sm mb-1">{t("devtools.cacheRead")}</div>
      ...
      <Card title={t("devtools.costOverview")} className="mt-4">
        <div className="flex justify-around">
          <div className="text-center">
            <div className="text-zinc-500 text-sm mb-1">{t("devtools.totalTokens")}</div>
            <div className="text-3xl font-bold">{formatTokens(cost.total_tokens)}</div>
          </div>
          <div className="text-center">
            <div className="text-zinc-500 text-sm mb-1">{t("devtools.totalCost")}</div>
            <div className="text-3xl font-bold text-green-600">
              ${cost.total_cost_usd.toFixed(4)}
            </div>
          </div>
          <div className="text-center">
            <div className="text-zinc-500 text-sm mb-1">{t("common.model")}</div>
